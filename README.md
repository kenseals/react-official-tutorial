My version of React's official tutorial (tictactoe), including the 6 suggested improvements at the end of the tutorial. Each commit corresponds with the suggested improvements.
